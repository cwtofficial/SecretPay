...
contract SecretPayTest is Test {
    ...
    function _createTransfer(
        ...
        vm.prank(sender);
        secretPay.createTransfer{value: amount}(recipient, password, duration);
    ...
    function testCreateTransferFunction() public {
        ...
        secretPay.createTransfer{value: TRANSFER_AMOUNT}(
            bob,
            PASSWORD,
            DURATION
        );
        assertEq(
            secretPay.transferCount(),
            1,
            "Transfer should be incremented to 1"
        );
        (
            address sender,
            address recipient,
    ...
    function testCreateMultipleTransfers() public {
        // Arrange & Act
        uint256 transferId1 = _createTransfer(
            alice,
            bob,
            PASSWORD,
            1 ether,
        ...
        uint256 transferId2 = _createTransfer(
            alice,
            charles,
            "password2",
            2 ether,
        ...
        uint256 transferId3 = _createTransfer(
            bob,
            alice,
            "password3",
            0.5 ether,
    ...
    function testClaimTransfer() public {
        ...
        uint256 transferId = _createTransfer(
            alice,
            bob,
            PASSWORD,
            TRANSFER_AMOUNT,
        ...
        assertEq(
            bobBalanceAfter,
            bobBalanceBefore + TRANSFER_AMOUNT,
            "Bob should receive the transfer amount"
        );
...
// npm install --save-dev prettier prettier-plugin-solidity -> added prettier for better code formatting and added .prettierrc file in root folder
